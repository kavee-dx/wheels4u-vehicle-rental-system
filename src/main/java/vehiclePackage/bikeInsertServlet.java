...
@WebServlet("/bikeInsertServlet")
@MultipartConfig
public class bikeInsertServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//Get uploaded image
		Part filePart = request.getPart("bikeimg");
		...
		isTrue = bikeController.insertdata(fileName, bikeName, brand, type, model, color, plateNumber, year, mileage, price, status);
