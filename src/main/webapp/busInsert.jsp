...
<div class="vehicleContainer">
    ...
    <form class="addvehicleForm" action="busInsertServlet" method="POST" enctype = "multipart/form-data">

    <h1 class="topic1"> Add New Bus </h1>


		Bus Image:
        <input type="file" name="busimg" placeholder="Upload bus image..." required>
        
        <br>

		Bus Name: 
        <input type="text" name="busName" placeholder="Enter bus name..." required maxlength = "100">

        <br>


 		Bus Brand:
        <input type="text" name="brand" placeholder="Enter bus brand..." required maxlength = "50">

        <br>

        Bus Type: 
        <input type="text" name="type" placeholder="Enter bus type..." required maxlength = "50">

        <br>

        Bus Model: 
        <input type="text" name="model" placeholder="Enter bus model..." required maxlength = "50">

        <br>

        Color:
        <input type="text" name="color" placeholder="Enter bus color" required maxlength = "50">
