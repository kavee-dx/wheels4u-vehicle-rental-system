...
<%
		...
		String vanimg = request.getParameter("vanimg");
...
<div class="vehicleContainer">
    ...
    <form class="updatevehicleForm" action="vanUpdateServlet" method="POST" enctype = "multipart/form-data">

    <h1 class="topic1"> Update Van Information </h1>
    
    	
    	Van ID: 
    	<input type="text" name="vanId" value="<%=vanId%>" readonly>
    	
    	<br>
    	
    	<!-- Show current car image -->
    	Current Van Image:<br>
    	<img src="vehiclepics/<%=vanimg%>" alt="Van Image" width="150" height="100" style="object-fit: cover; border: 1px solid #ccc;"><br><br>

    	<!-- File input to upload new image -->
    	<label>Change Van Image:</label>
    	<input type="file" name="newvanimg" accept="image/*"><br><br>

    	<!-- Hidden input to keep old image if no new image uploaded -->
    	<input type="hidden" name="oldvanimg" value="<%=vanimg%>">
		...
		Van Name: 
        <input type="text" name="vanName" value="<%=vanName%>" placeholder="Enter van name..." required maxlength = "100">

        <br>

 		Van Brand:
        <input type="text" name="brand" value="<%=brand%>" placeholder="Enter van brand..." required maxlength = "50">

        <br>

        Van Type: 
        <input type="text" name="type" value="<%=type%>" placeholder="Enter van type..." required maxlength = "50">

        <br>

        Van Model: 
        <input type="text" name="model" value="<%=model%>" placeholder="Enter van model..." required maxlength = "50">

        <br>

        Color:
        <input type="text" name="color" value="<%=color%>" placeholder="Enter van color" required maxlength = "50">
