...
<%
		...
		String bikeimg = request.getParameter("bikeimg");
...
<div class="vehicleContainer">
    ...
    <form class="updatevehicleForm" action="bikeUpdateServlet" method="POST" enctype = "multipart/form-data">

    <h1 class="topic1"> Update Bike Information </h1>
    
    	
    	Bike ID: 
    	<input type="text" name="bikeId" value="<%=bikeId%>" readonly>
    	
    	<br>
    	
    	<!-- Show current car image -->
    	Current Bike Image:<br>
    	<img src="vehiclepics/<%=bikeimg%>" alt="Bike Image" width="150" height="100" style="object-fit: cover; border: 1px solid #ccc;"><br><br>

    	<!-- File input to upload new image -->
    	<label>Change Bike Image:</label>
    	<input type="file" name="newbikeimg" accept="image/*"><br><br>

    	<!-- Hidden input to keep old image if no new image uploaded -->
    	<input type="hidden" name="oldbikeimg" value="<%=bikeimg%>">
		...
		Bike Name: 
        <input type="text" name="bikeName" value="<%=bikeName%>" placeholder="Enter bike name..." required maxlength = "100">

        <br>

 		Bike Brand:
        <input type="text" name="brand" value="<%=brand%>" placeholder="Enter bike brand..." required maxlength = "50">

        <br>

        Bike Type: 
        <input type="text" name="type" value="<%=type%>" placeholder="Enter bike type..." required maxlength = "50">

        <br>

        Bike Model: 
        <input type="text" name="model" value="<%=model%>" placeholder="Enter bike model..." required maxlength = "50">

        <br>

        Color:
        <input type="text" name="color" value="<%=color%>" placeholder="Enter bike color" required maxlength = "50">
